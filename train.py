...
def train(
    ...
    if resume:
        ...
        #print(cfg.endswith('yolov3.cfg'))
        if cfg.endswith('yolov3_1248x384_4class_4anchor.cfg'):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='cfg/yolov3_1248x384_4class_4anchor.cfg', help='cfg file path')
    ...
    parser.add_argument('--img-size', type=int, default=[1248, 384], nargs='+', help='pixels')
