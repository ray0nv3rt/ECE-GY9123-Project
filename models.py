...
class YOLOLayer(nn.Module):
    ...
    def forward(self, p_cat,  img_size, targets=None, classifier=None, test_emb=False):
        ...
        p, p_emb = p_cat[:, :split, ...], p_cat[:, split:, ...] # alternate with filters num in cfg
        nB, nGh, nGw = p.shape[0], p.shape[-2], p.shape[-1]

#        print([p_cat.shape, p.shape])
#        print([nB, nGh, nGw])
...
#        print([nB, self.nA, self.nC + 5, nGh, nGw])
#        print(p.view(nB, self.nA, self.nC + 5, nGh, nGw))
