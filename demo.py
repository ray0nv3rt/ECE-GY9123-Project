...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='cfg/yolov3_1248x384_4anchor.cfg', help='cfg file path')
    parser.add_argument('--weights', type=str, default='weights/yolov3_1248x384_4anchor_1r1/weights_epoch_20.pt', 
help='path to weights file')
    ...
    parser.add_argument('--input-video', type=str, default='dataset/KITTI/test-1/images/0000.mp4', help='path to the input video')
    parser.add_argument('--input-video-images', type=str, default='dataset/KITTI/test-1/images/0000/', help='path to the input images sequence')
